...
CUSTOM_HAL_IMGSENSOR = s5kgm1_mipi_raw s5kgd1sp_mipi_raw gc2385_mipi_raw ov13855_mipi_raw gc2385main3_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = gc2385_mipi_raw
CUSTOM_HAL_MAIN3_IMGSENSOR = gc2385main3_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kgm1_mipi_raw
CUSTOM_HAL_MSENSORLIB = memsic
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB2_IMGSENSOR = ov13855_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = s5kgd1sp_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5kgm1_mipi_raw s5kgd1sp_mipi_raw gc2385_mipi_raw ov13855_mipi_raw gc2385main3_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = yes
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc2385_mipi_raw
CUSTOM_KERNEL_MAIN3_IMGSENSOR = gc2385main3_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = 
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kgm1_mipi_raw
...
CUSTOM_KERNEL_SUB2_IMGSENSOR = ov13855_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR = s5kgd1sp_mipi_raw
...
FOTA_INFO_OEM = tydtech6771_10.0
FOTA_INFO_PLATFORM = MTK6771_10.0
FPGA_EARLY_PORTING = no
FREEME_APPLOCK_SUPPORT = no
FREEME_BOARD_CFG_PT_FOR = 64bit
FREEME_BOOT_ANIMATION_CUSTOMIZED = yes
FREEME_BOOT_AUDIO_SUPPORT = yes
FREEME_BUILD_USER_DEXPREOPT = yesud
FREEME_CAMERA_SUPPORT = yes
FREEME_CONFIG_AUDIBLE_NOTIFICATION = pizzicato.ogg
FREEME_CONFIG_AUDIBLE_RINGTONE = BeatPlucker.ogg
FREEME_CONFIG_AUDIBLE_RINGTONE2 = BeatPlucker.ogg
FREEME_DEVICE_LCD_DENSITY = 480
FREEME_FACTORYMODE_INSTRUMENT = no
FREEME_FACTORY_TEST_CAMERA_BACK_VICE = yes
FREEME_FACTORY_TEST_CAMERA_BACK_VICE_2 = yes
FREEME_FACTORY_TEST_LIGHT_ATTENTION = no
FREEME_FACTORY_TEST_NFC = yes
FREEME_FACTORY_TEST_REBOOT = yes
FREEME_FINGERPRINT_SUPPORT = q71_chipsailing_tee_cs2811
FREEME_FLASH_TYPE = UMCP_12848
FREEME_FONTS_CUSTOMIZED = no
FREEME_FONTS_EXTERNAL = yes
FREEME_GAMEMODE_SUPPORT = no
FREEME_GAMEMODE_TOOL_SUPPORT = no
FREEME_GESTURE_TOUCH_THREE_POINT = yes
FREEME_GLOVE_MODE_SUPPORT = no
FREEME_MAC_AUTOGEN_SUPPORT = yes
FREEME_MTK_BOOTANIMATION_SUPPORT = yes
FREEME_NAVIGATION = collapsable swipeup
FREEME_PACKAGE_FreemeSuperShot = yes
FREEME_PACKAGE_OVERRIDES = Protips
FREEME_PRODUCT_BASED = k71v1_64_bsp
FREEME_PRODUCT_BOARD = px5
FREEME_PRODUCT_CHIPVENDOR = mtk
FREEME_PRODUCT_FOR = 
FREEME_PRODUCT_INFO_BASEBAND_VERNO = 
FREEME_PRODUCT_INFO_BOARD = Freeme
FREEME_PRODUCT_INFO_BRAND = UMIDIGI
FREEME_PRODUCT_INFO_DEVICE = F2
FREEME_PRODUCT_INFO_FLAVOR = 
FREEME_PRODUCT_INFO_HW_VERNO = PX5
FREEME_PRODUCT_INFO_KERNEL_VERNO = 
FREEME_PRODUCT_INFO_MANUFACTURER = Droi
FREEME_PRODUCT_INFO_MODEL = F2
FREEME_PRODUCT_INFO_NAME = F2
FREEME_PRODUCT_INFO_SW_VERNO = UMIDIGI_F2_V1.0_20191122
FREEME_PRODUCT_INFO_SW_VERNO_INTERNAL = PX556CTG13B.KW.F2.HB.Q0.FHP.S78.1221.V3.06
FREEME_PRODUCT_LOCALES = 
FREEME_PRODUCT_LOCALES_DEFAULT = en_US
FREEME_PRODUCT_LOCALES_FILTER_OUT = 
FREEME_REVERSE_SILENT = no
FREEME_SHUT_ANIMATION_SUPPORT = no
FREEME_SHUT_AUDIO_SUPPORT = no
FREEME_SOUNDS_EXTERNAL = yes
FREEME_SOUNDS_FILTER_OUT = Fermium.ogg Nobelium.ogg Oxygen.ogg Helium.ogg Alarm_Classic.ogg Platinum.ogg Krypton.ogg Neptunium.ogg
FREEME_SUPPORT_NXP_NFC = yes
FREEME_SYS_BLUETOOTH_NAME = F2
FREEME_SYS_CHANNEL = DROIPCB
FREEME_SYS_CUSTOMER = KW
FREEME_SYS_CUSTOMER_BRANCH = 1
FREEME_SYS_EXIF_NAME = 
FREEME_SYS_LABEL = FreemeOS
FREEME_SYS_MTP_PTP_NAME = F2
FREEME_SYS_TIMEZONE = Asia/Shanghai
FREEME_SYS_VERSION = 9.0.0
FREEME_SYS_WLAN_NAME = F2
FREEME_TOUCH_PROTECT = no
FREEME_WALLPAPERS_CUSTOMIZED = yes
FREEME_WALLPAPERS_FILTER_OUT = 
GAPPS_BUILD_ID = android-droi
...
PRODUCT_SOUNDRECORDER_M_OVERRIDES = yes
RECORD_SCREEN_SUPPORT = no
ROCK_GOTA_SUPPORT = no
SIM_ME_LOCK_MODE = 0
SIM_REFRESH_RESET_BY_MODEM = yes
SPLIT_SCREEN_SUPPORT = yes
SPM_FW_USE_PARTITION = yes
ST_NFC_CHIP_VERSION = 
SYSTEM_AS_ROOT = yes
TRUSTKERNEL_TEE_SUPPORT = no
TRUSTONIC_TEE_SUPPORT = no
TYD_LAUNCHER_CUSTOM_STYLE = no
TYD_LOCK_BUILD_NUMBER = yes
VOLUME_WAKEUP_SUPPORT = no
